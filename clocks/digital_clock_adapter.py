...
from utils.time_conversion_helper import TimeConversionHelper  # Импорт хелпера
...
class DigitalClockAdapter(BaseDigitalClock):
    ...
    def get_date_time(self) -> datetime:
        ...
        # Получаем время с использованием нового ClockTime
        time = TimeConversionHelper.convert_angles_to_time(
